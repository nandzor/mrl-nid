...
/** The main activity for the Spell3D sample. */
public class Spell3D extends Activity
{
    ...
    {   
        ...
        {
            QCAR.setInitParameters(Spell3D.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(Spell3D.this).create();
    ...
    public void getObjectNameDB()
    {
    	DebugLog.LOGD("Spell3Ds:getObjectName()");
    }
    ...
    {
        DebugLog.LOGD("Spell3Ds::onCreate");
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    {
        DebugLog.LOGD("Spell3Ds::onResume");
        super.onResume();
    ...
    {
        DebugLog.LOGD("Spell3Ds::onPause");
        super.onPause();
    ...
    {
        DebugLog.LOGD("Spell3Ds::onDestroy");
        super.onDestroy();
     ...
     * access by Spell3Ds::onResume() and InitQCARTask::onPostExecute(). */
    ...
    {        
        ...
        //mRenderer.DBhelper=helper;
        //mRenderer.addObjectsInDatabase();
