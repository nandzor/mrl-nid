...
public class eventTrigger extends Activity
{
    ...
    {   
        ...
        {
            QCAR.setInitParameters(eventTrigger.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(eventTrigger.this).create();
