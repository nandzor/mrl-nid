...
Java_com_nid_mrl_eventTrigger_eventTrigger_setActivityPortraitMode(JNIEnv *, jobject, jboolean isPortrait)
{
...
Java_com_qualcomm_QCARSamples_FrameMarkers_FrameMarkersRenderer_renderFrame(JNIEnv *env, jobject obj)
{
    //LOG("Java_com_qualcomm_QCARSamples_FrameMarkers_GLRenderer_renderFrame");
 	...
 	jmethodID value = env->GetMethodID(activityClass, "actionTrigger", "(I)V");
   ...
   // for(int j=1;j<=100;j++)    
	//printf("Number of Trackables : "+ state.getNumActiveTrackables());
    ...
    for(int tIdx = 0; tIdx < state.getNumActiveTrackables(); tIdx++)
    {
		...
		if(flag==0)  
		{
				env->CallVoidMethod(obj, value, textureIndex);   // This calls acionTrigger method once.
		}	
...
JNIEXPORT void JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_initApplicationNative(
...
JNIEXPORT void JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_deinitApplicationNative(
...
JNIEXPORT void JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_startCamera(JNIEnv *,
                                                                         jobject)
{
...
JNIEXPORT void JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_stopCamera(JNIEnv *,
                                                                   jobject)
{
...
Java_com_nid_mrl_eventTrigger_eventTrigger_toggleFlash(JNIEnv*, jobject, jboolean flash)
{
    return QCAR::CameraDevice::getInstance().setFlashTorchMode((flash==JNI_TRUE)) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_autofocus(JNIEnv*, jobject)
{
    return QCAR::CameraDevice::getInstance().startAutoFocus()?JNI_TRUE:JNI_FALSE;
}

JNIEXPORT jboolean JNICALL
Java_com_nid_mrl_eventTrigger_eventTrigger_setFocusMode(JNIEnv*, jobject, jint mode)
{
